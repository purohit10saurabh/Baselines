...
class XMLModel(Model):
    ...
    def __init__(self, labels_num, hidden_size, device_ids=None, attn_device_ids=None,
        ...
        self.network, self.attn_weights = self.model, Empty()
    ...
    def get_optimizer(self, **kwargs):
        params = [{'params': self.network.parameters()}, {'params': self.attn_weights.parameters(), 'sparse': True}]
        self.optimizer = DenseSparseAdam(params, **kwargs)
