...
class Network(nn.Module):
    ...
    """
    def __init__(self, emb_size, vocab_size=None, emb_init=None, emb_trainable=True, emb_dropout=0.2,
                 retain_emb_grad=False, **kwargs):
        super(Network, self).__init__()
        self.emb = Embedding(vocab_size, emb_size, emb_init, emb_trainable, emb_dropout, retain_emb_grad)
