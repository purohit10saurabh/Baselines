...
trn_ft_file="${model_data_dir}/tr_X_Xf.txt"
trn_lbl_file="${model_data_dir}/tr_X_Y.txt"
tst_ft_file="${model_data_dir}/ts_X_Xf.txt"
tst_lbl_file="${model_data_dir}/ts_X_Y.txt"
